...
flappyImg.src = 'assets/flappy-ghost.png'
...
function ShowEndMenu() {
    ...
    //This way we always update our highscore at the end of our game if we have higher high score than the previous
    if (highscore < score) {
        highscore = score;
    }
...
function loop() {
    ...
    //Move the pipes
    pipeX -= 1.5;
    //if the pipe moves out of frame we need to reset the pipe
    if (pipeX < -50) {
        pipeX = 400;
